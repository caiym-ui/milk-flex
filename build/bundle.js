...
Flex.propTypes = {
  ...
  align: _react.PropTypes.oneOf(['top', 'start', 'middle', 'center', 'bottom', 'end', 'baseline', 'stretch']),
  alignCenter: _react.PropTypes.oneOf(['start', 'end', 'center', 'between', 'around', 'stretch']),
